...
import { makeCreateUserController, makeUserAuthenticationController, makeUpdateUserController, makeDeleteUserController, makeGetOneUserController } from '../factories/controllers/user'
...
export default (router: Router): void => {
  ...
  router.get('/user/:id', adaptRoute(makeGetOneUserController()))
}
